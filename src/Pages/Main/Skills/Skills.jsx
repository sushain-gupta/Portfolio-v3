...
const Skills = () => {
	...
	return (
		<section ref={ref} name="skills" className="flex flex-col items-center justify-center text-center py-28 rounded-3xl sm:text-start">
			...
			<div className="grid grid-cols-3 gap-4 mx-auto my-10 w-full md:w-max sm:grid-cols-4 md:grid-flow-col-4 lg:grid-cols-6 2xl:grid-cols-7 sm:gap-5 rounded-3xl">
